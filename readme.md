...
![群二维码](https://github.com/RKQF-JVS/jvs-docker-compose/assets/94048608/99036eb7-5153-4057-a600-124e1426efcd)



如因人数限制无法加群时，可加运营同学拉入技术交流群

![输入图片说明](img/image011.png)
...
3.1 下载项目
```
git clone https://github.com/RKQF-JVS/jvs-docker-compose.git && cd jvs-docker-compose && chmod -R 777 data && chmod -R 777 mysql && chmod -R 644 data/mysqlcnf
```
3.2 替换服务器ip地址
