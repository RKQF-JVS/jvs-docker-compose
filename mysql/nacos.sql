...
INSERT INTO `config_info` VALUES (1016, 'jvs-teamwork.yml', 'DEFAULT_GROUP', 'spring:\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://jvs-mysql:3306/jvs-team?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&nullCatalogMeansCurrent=true\n    username: root\n    password: root\n    hikari:\n      maximum-pool-size: 100', '30599d859de10778a9adfe2b838215c9', '2022-05-08 03:32:14', '2022-05-08 03:32:14', NULL, '172.18.0.1', '', 'jvs', NULL, NULL, NULL, 'yaml', NULL);
