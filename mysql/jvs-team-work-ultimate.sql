...
CREATE TABLE `plugins`  (
  ...
  `plugin_type` enum('base','dev','expand') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'base' COMMENT '插件类型',
  ...
  `is_default` tinyint(1) NULL DEFAULT 0 COMMENT '是否为默认插件',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of plugins
-- ----------------------------
INSERT INTO `plugins` VALUES ('0b16f5461e62a748dbfa9f89ae7f330f', '共享文档', '计划成员可执行创建文件夹并上传计\r\n划相关文件，同时可查看所有任务附件', NULL, 'expand', 4, '/project/space/documents', 0);
INSERT INTO `plugins` VALUES ('1194ab903fd9e6509b4cc6da803d57f2', '人力工时', '用于项目管理中的工时查看、统计与导出', 'iconfont icon-tianjiagongshi', 'dev', 8, NULL, 0);
INSERT INTO `plugins` VALUES ('3055bf78ebdc2b37820be536e26e1f66', '费用成本', '多维度通过人力、时间等分析，对项目整体投入成本及各子项费用统计和管理。', 'iconfont icon-bangongshichengben', 'dev', 11, NULL, 0);
INSERT INTO `plugins` VALUES ('4a3c13f0a2c113cb6c2e134f7754bf5d', '在线报表', '在线设计报表及数据统计方式，并生\r\n成计划报表。', 'iconfont icon-baobiao', 'dev', 7, NULL, 0);
INSERT INTO `plugins` VALUES ('50e525fc8387a1c0ef1907a30072c1e4', '计划概览', '展示当前计划公告、动态、周期级相\r\n关统计信息。', 'iconfont icon-lvzhou_gailan', 'base', 2, '/project/space/overview', 1);
INSERT INTO `plugins` VALUES ('6627e2c4e58621d019df383ded145293', '数据统计', '多维度统计计划数据，包含执行周期、\r\n工作量、任务对比数据等。', 'iconfont icon-tongji', 'dev', 6, NULL, 0);
INSERT INTO `plugins` VALUES ('b1bdbe2490724e42f89f7ca0fe2557f1', '缺陷管理', '记录缺陷的生命周期数据，可以对缺陷进行全方位记录与跟踪。', 'iconfont icon-quexianjiancechaxun', 'dev', 9, NULL, 0);
INSERT INTO `plugins` VALUES ('c66b5192a0988ab3188fcc13bb555c84', '风险管控', '通过风险应用，可以对项目中的风险项进行汇总和沉淀。', 'iconfont icon-fengxiantishi', 'dev', 10, NULL, 0);
INSERT INTO `plugins` VALUES ('c98b5fe09c39abe76bd3d758c4d60816', '任务看板', '以任务看板方式将计划进行细分，随\r\n时了解计划进度。', 'iconfont icon-renwu', 'base', 1, '/project/space/task', 1);
INSERT INTO `plugins` VALUES ('cc36d5051660c949a0d8c7a1d1722247', '协同设计', '计划成员可执多人在线设计文件内容，\r\n实现文件版本记录，发布管理。', 'iconfont icon-bianji', 'expand', 5, '/project/space/teamwork', 0);
INSERT INTO `plugins` VALUES ('ed7ee8e9a0fe457d9ee9b876ed089548', '甘特图', '以甘特图方式将各个任务执行周期进\r\n进行展示，可直观了解当前任务进度。', 'iconfont icon-gantetu', 'base', 3, '/project/space/gantt', 1);
...
-- ----------------------------
-- Table structure for project_branch
-- ----------------------------
DROP TABLE IF EXISTS `project_branch`;
CREATE TABLE `project_branch`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分支id',
  ...
  `branch_remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分支说明',
  `root_commit_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分支根节点id（为-1则为起始节点）',
  `head_commit_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分支结束节点',
  `default_branch` tinyint(1) NULL DEFAULT 0 COMMENT '默认分支',
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '显示颜色',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '编辑时间',
  `create_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人id',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人名称',
  ...
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目 多人协同(暂定) 分支' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of project_branch
-- ----------------------------

-- ----------------------------
-- Table structure for project_branch_commit
-- ----------------------------
DROP TABLE IF EXISTS `project_branch_commit`;
CREATE TABLE `project_branch_commit`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '提交记录id',
  `project_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '项目id',
  `branch_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分支id',
  `merge_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '合并源提交记录id',
  `commit_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '记录节点名称',
  `commit_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '提交备注',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '头像',
  `parent_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '上级节点id（-1为根节点）',
  `commit_statistics` json NULL COMMENT '节点统计',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '编辑时间',
  `create_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人id',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人名称',
  ...
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目 多人协同(暂定) 分支 提交记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of project_branch_commit
-- ----------------------------

-- ----------------------------
-- Table structure for project_branch_file
-- ----------------------------
DROP TABLE IF EXISTS `project_branch_file`;
CREATE TABLE `project_branch_file`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件、文件夹id',
  `branch_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分支id',
  `commit_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '提交记录id',
  `project_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '项目id',
  `origin_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '初始文件id、原文件id',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件/目录名称',
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件/目录路径',
  `dir_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '文件目录',
  `file_version` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件版本',
  `file_size` bigint(20) NULL DEFAULT NULL COMMENT '文件大小',
  `is_dir` tinyint(1) NULL DEFAULT 0 COMMENT '是否为目录 0否 1是',
  `status` enum('add','edit','del','noChange') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件状态',
  ...
  `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件/目录路径(minio)',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '编辑时间',
  `create_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人id',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `update_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人id',
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人名称',
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UQ_NAME`(`name`, `dir_path`, `commit_id`, `file_type`) USING BTREE COMMENT '同目录下不存在重名文件'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目 多人协同(暂定) 分支 提交记录 文件' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of project_branch_file
-- ----------------------------

-- ----------------------------
-- Table structure for project_branch_working
-- ----------------------------
DROP TABLE IF EXISTS `project_branch_working`;
CREATE TABLE `project_branch_working`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `project_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '项目id',
  `branch_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分支id',
  ...
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目 协同 分支 工作分支' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of project_branch_working
-- ----------------------------
...
CREATE TABLE `project_folder`  (
  ...
  `project_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '计划id',
  `p_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '上级文件夹id',
  `cover_color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '封面颜色',
  `file_size` bigint(20) NULL DEFAULT NULL COMMENT '文件大小',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人id',
  ...
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '计划-文件夹' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for project_folder_file
-- ----------------------------
DROP TABLE IF EXISTS `project_folder_file`;
CREATE TABLE `project_folder_file`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `project_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '计划id',
  `folder_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件夹id',
  `file_name_customization` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件名称',
  `bucket_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '桶名称',
  `file_link` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '文件链接',
  `file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件名称(包含minion路径)',
  `original_file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件原始名称',
  `file_size` bigint(20) NULL DEFAULT NULL COMMENT '文件大小',
  ...
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '计划-文件夹-文件' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of project_folder_file
-- ----------------------------
...
CREATE TABLE `project_plugins`  (
  ...
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新人名称',
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户id',
  `sort_num` int(11) NULL DEFAULT NULL COMMENT '排序序号 值越小显示的越前',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `sys_identifying` VALUES ('06c8c2a6f93cef6aee747f3c8ae0d90d', '文件移动', 'branch.file.move', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 14:40:00', '2023-01-13 14:40:00', 'wanglin');
INSERT INTO `sys_identifying` VALUES ('09b963cfb431f24d2d7894f88d9c0f1d', '更名', 'branch.file.rename', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:21:40', '2023-01-13 10:21:40', 'wanglin');
...
INSERT INTO `sys_identifying` VALUES ('1af39783c0dc878f0de2f81910775812', '文件删除', 'branch.file.del', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:23:41', '2023-01-13 10:23:41', 'wanglin');
...
INSERT INTO `sys_identifying` VALUES ('7a20a38cf60a02057f2adf7e5a13ff5f', '存档比较', 'branch.commit.compare', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:22:26', '2023-01-13 10:22:26', 'wanglin');
...
INSERT INTO `sys_identifying` VALUES ('8789a6b5686b61f2b9081a7ceb390e8a', '新建文档/上传文件夹/新建文件夹', 'branch.file.create', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:20:48', '2023-01-13 10:20:48', 'wanglin');
INSERT INTO `sys_identifying` VALUES ('8f0f41b23eb696c6ed648a1ff12264e4', '新建分支', 'branch.create', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:21:54', '2023-01-13 10:21:54', 'wanglin');
INSERT INTO `sys_identifying` VALUES ('95b8af5e65f0ec90ac4f900e40328cde', '合并分支', 'branch.merge', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:22:09', '2023-01-13 10:22:09', 'wanglin');
...
INSERT INTO `sys_identifying` VALUES ('a0e80h6f2157c123226e98b189919e5f', '插件使用', 'project.plugin.use', 'project', '484929d49e10f203a7fc536e9582f629', 'wl', '2022-03-24 16:49:25', '2022-07-01 17:55:11', 'wl');
...
INSERT INTO `sys_identifying` VALUES ('b31b3651daf26b9179b0146a929bc393', '文件下载', 'branch.file.download', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:21:08', '2023-01-13 10:21:08', 'wanglin');
...
INSERT INTO `sys_identifying` VALUES ('cff2a8610b28b850015aeee75931ee3c', '节点编辑', 'branch.commit.edit', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:23:08', '2023-01-13 10:23:08', 'wanglin');
...
INSERT INTO `sys_identifying` VALUES ('e2644f9afa8b533fe887a626c6a5fe61', '在线编辑', 'branch.file.edit', 'branch', 'fa0c7f28b86a09f5ee4ad1e27ceb890e', 'wanglin', '2023-01-13 10:21:24', '2023-01-13 10:21:24', 'wanglin');
...
CREATE TABLE `sys_role`  (
  ...
  `can_edit` tinyint(1) NULL DEFAULT 1 COMMENT '是否可编辑',
  `tenant_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户ID',
  `create_by_id` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者id',
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
